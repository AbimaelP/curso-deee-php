...
<body>
    <form method="post">
        ...
        <div class="input-group">
            ...
            <input class="erro-input" type="text" placeholder="Nome Completo" name="nome" required>
        ...
        <div class="input-group">
            ...
            <input type="password" placeholder="Repita a senha criada" name="repete_senha" required>
        </div>   
